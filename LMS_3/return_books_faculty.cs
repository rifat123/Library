...
namespace LMS_3
{
    public partial class return_books_faculty : Form
    {
        ...
        private void return_books_faculty_Load(object sender, EventArgs e)
        {
        ...
        public void fill_grid(string enrollment)
        {
            ...
            cmd.CommandText = "select * from issue_books_faculty where faculty_enrollment = '" + enrollment.ToString() + "' and book_return_date = ''";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from issue_books_faculty where id = "+i+"";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update issue_books_faculty set book_return_date = '" + dateTimePicker1.Value.ToString() + "' where id = " + i + "";
