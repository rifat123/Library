      ...
      /*  private void panel1_Paint(object sender, PaintEventArgs e)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (books_qty > 0)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "insert into issue_books values('" + txt_enrollment.Text + "','" + txt_studentname.Text + "','" + txt_studentdept.Text + "','" + txt_studentsem.Text + "','" + txt_studentcontact.Text + "','" + txt_studentemail.Text + "','" + txt_boksname.Text + "','" + dateTimePicker1.Value.ToString() + "','')";
